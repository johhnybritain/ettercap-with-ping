...
{
   fprintf(stdout, "\nInline help:\n\n");
   fprintf(stdout, " [aA]      - print the active connections list\n");
   fprintf(stdout, " [xX]      - ping the active connections list\n");
   fprintf(stdout, " [vV]      - change the visualization mode\n");
   fprintf(stdout, " [pP]      - activate a plugin\n");
   fprintf(stdout, " [fF]      - (de)activate a filter\n");
   fprintf(stdout, " [lL]      - print the hosts list\n");
   fprintf(stdout, " [oO]      - print the profiles list\n");
   fprintf(stdout, " [cC]      - print the connections list\n");
   fprintf(stdout, " [sS]      - print interfaces statistics\n");
   fprintf(stdout, " [<space>] - stop/cont printing packets\n");
